...
config={"user_key":"0c39431141b0f0d86bcc34e280c607ff"}
zomato = zomatopy.initialize_app(config)

def results(loc,cuisine,price):
	print(f'actions search restaurant: {loc}, {cuisine}, {price}')
	...
	if cuisine: cuisine = cuisine.lower()
	...
	df = pd.DataFrame()
	for i in list1:
		results = zomato.restaurant_search(i, lat, lon, str(cuisines_dict.get(cuisine)), limit=20)
	...
	if price == 'to 700': price = 'between 300 to 700'
